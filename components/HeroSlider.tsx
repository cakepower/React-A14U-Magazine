...
const HeroSlider: React.FC = () => {
  ...
  useEffect(() => {
    ...
    return clearTimers;
  }, [currentIndex, goToNext, clearTimers, isTransitioning]);
        ...
        {slides.map((slide: Slide, slideIndex: number) => {
            ...
            return (
              ...
              >
                ...
                <div className="absolute top-0 left-0 w-full h-full flex items-center justify-start p-8 md:p-16 lg:p-24">
